      ...
      <section className="mt-5 grid gap-5 xl:grid-cols-3">
        ...
        <ProofCard
          ...
          items={[
            ...
            `${getBangaloreFit(bundle.creator)}/100 Bangalore relevance`
          ]}
        />
        <ProofCard
      ...
      <section className="mt-5 grid gap-5 xl:grid-cols-3">
        ...
        <AgentlySignalCard
          ...
          signals={[
            ...
            `${getBangaloreFit(bundle.creator)}/100 Bangalore relevance based on city, language, and content fit`,
            ...
            bundle.creator.verification_tier ? `Verification tier: ${String(bundle.creator.verification_tier).replaceAll("_", " ")}` : "Verification tier still needs review"
          ]}
        />
