...
// Demo payment rows use the canonical 3% Agently protection fee
...
export const payments: Payment[] = [
  { id: "pay1", deal_id: "d1", amount_cents: 1850000, platform_fee_cents: 55500, creator_payout_cents: 1794500, status: "pending" },
  { id: "pay2", deal_id: "d2", stripe_checkout_session_id: "cs_demo_funded", amount_cents: 1225000, platform_fee_cents: 36750, creator_payout_cents: 1188250, status: "funded", funded_at: "2026-04-20T16:00:00Z" },
  { id: "pay3", deal_id: "d3", stripe_checkout_session_id: "cs_demo_ready", amount_cents: 680000, platform_fee_cents: 20400, creator_payout_cents: 659600, status: "release_ready", funded_at: "2026-04-03T16:00:00Z" }
];
