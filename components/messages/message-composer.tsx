  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        {status === "error" ? <p className="min-w-0 text-sm text-destructive">Could not send message.</p> : <p className="min-w-0 text-sm text-muted-foreground">Messages save to your campaign inbox.</p>}
