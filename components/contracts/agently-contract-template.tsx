...
3.2 Agently charges a 3% platform fee on the contract value. The fee is deducted from the contract value before the Talent's payout is released. Brands who want the Talent to receive a specific net amount should gross up the contract value accordingly when sending the offer.
